package com.example.binaryrodeci;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // input is where the user will input the d
        // output is where the user will get the output in the form of decimal
        // submit is the button created to submit the binary number entered by the user
        // reset is the button to rweset the answer
